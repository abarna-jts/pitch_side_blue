        ...
        <div class="container">
                ...
                <div class="menu-container">
                    <div class="menu-items">
                        <ul class="menu-list">
                            ...
                            <li class="menu-item">
                                <h4 style="text-align: start;">CRISPY FRIED VEGETABLE WITH HOT GARLIC SAUCE<span class="price">325</span></h4>
                                <p>A casual delicious starter for vegetarian hunters.</p>
                            </li>
                            <li class="menu-item">
                                <h4>GREEN CHILLI PANNER<span class="price">349</span></h4>
                                <p>Hot and spicy Asian preparation with cottage cheese, peppers and onions.</p>
                            </li>
                            <li class="menu-item">
                                <h4>GINGER GARLIC CHICKEN<span class="price">399</span></h4>
                                <p>Tender chicken draped in most irresistible Asian marination.</p>
                            </li>
                            <li class="menu-item">
                                <h4>SZECHWAN CRISPY LAMB<span class="price">399</span></h4>
                                <p>Lamb strips coated with chines spices and sauteed with hot garlic sauce.</p>
                            </li>
                            <li class="menu-item">
                                <h4>WOK TOSSED CHINESE FISH <span class="price">399</span></h4>
                                <p>Pan fried fish fillet tossed with soya, chilli and garlic.</p>
                            </li>
                            <li class="menu-item">
                                <h4>DRAGON GARLIC SHRIMPS<span class="price">399</span></h4>
            ...
            <div class="tab-content" id="tamil_nadu">
                <div class="menu-container">
                        <div class="menu-items">
                            <ul class="menu-list">
                                <li class="menu-item">
                                    <h4>CHETTINAD DRY PANEER<span class="price">349</span></h4>
                                    <p>Sautéed Cottage cheese rubbed with roasted chettinad masala tempered with fried coconut and chilies.</p>
                                </li>
                                <li class="menu-item">
                                    <h4 style="text-align: start;">MUSHROOM PEPPER SAUTE<span class="price">349</span></h4>
                                    <p>Sauteed mushroom with south Indian spices.</p>
                                </li>
                                <li class="menu-item">
                                    <h4>ROYAPETTAH'S MILAGA BAJJI<span class="price">249</span></h4>
                                    <p>Just bajji for perfect drinks and perfect weather.</p>
                                </li>
                                <li class="menu-item">
                                    <h4>KONGUNADU KOZHI THOKKU<span class="price">399</span></h4>
                                    <p>Delicious chicken from Kongumandalam's authentic spices.</p>
                                </li>
                                <li class="menu-item">
                                    <h4>NADAN FRIED PRAWNS<span class="price">399</span></h4>
                                    <p>Calling all seafood lovers to taste and party well.</p>
                                </li>
                                <li class="menu-item">
                                    <h4>MUTTON SUKKA<span class="price">420</span></h4>
                                    <p>Lamb popular and delicious combination for Brandy.</p>
                                </li>
                                <li class="menu-item">
                                    <h4>ROYAPETTAH'S TAWA BEEF<span class="price">375</span></h4>
            ...
            <div class="menu-container">
                    <div class="menu-items">
                        <ul class="menu-list">
                            <li class="menu-item">
                                <h4>MELTING CHEESE NUGGETS<span class="price">365</span></h4>
                                <p>Fried cheese fillet and chips.</p>
                            </li>
                            <li class="menu-item">
                                <h4 style="text-align: start;">JALAPENO CHEESE BALL<span class="price">365</span></h4>
                                <p>Homemade cheese ball stuffed with jalapeno.</p>
                            </li>
                            <li class="menu-item">
                                <h4>SPICY CHICKEN POPS<span class="price">399</span></h4>
                                <p>Bar bite Crispy fried chicken dusted with peri peri.</p>
                            </li>
                            <li class="menu-item">
                                <h4>CHICKEN WINGS BBQ/ POMMEGRANATE<span class="price">399</span></h4>
            ...
            <div class="tab-content" id="platers">Platers items go here.</div>
            <div class="tab-content" id="rice_bowls">Rice Bowls items go here.</div>
            <div class="tab-content" id="gravy_bowls">Gravy Bowls items go here.</div>
        </div>
        </div>
    </section>
